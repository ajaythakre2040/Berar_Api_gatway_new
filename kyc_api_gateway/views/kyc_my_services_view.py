...
from kyc_api_gateway.serializers.uat_pan_request_log_serializer import (
    UatPanRequestLogSerializer,
)
from kyc_api_gateway.serializers.uat_bill_request_log_serializer import (
    UatBillRequestLogSerializer,
)
from kyc_api_gateway.serializers.uat_voter_details_log_serializer import (
    UatVoterRequestLogSerializer,
)
from kyc_api_gateway.serializers.uat_name_request_match_log_serializer import (
    UatNameMatchRequestLogSerializer,
)
from kyc_api_gateway.serializers.uat_rc_detail_log_serializer import (
    UatRcRequestLogSerializer,
)
from kyc_api_gateway.serializers.uat_driving_license_log_serializer import (
    UatDrivingLicenseRequestLogSerializer,
)
from kyc_api_gateway.serializers.uat_passport_log_serializer import (
    UatPassportRequestLogSerializer,
)
from kyc_api_gateway.serializers.uat_address_log_serializer import (
    UatAddressMatchRequestLogSerializer,
)
...
class KycMyClientServicesListAll(APIView):
    ...
    def get(self, request):
        ...
        if not user or not hasattr(user, "id"):
            services = KycMyServices.objects.filter(deleted_at__isnull=True).order_by(
                "id"
            )
        else:
            client_id = user.id
            ...
            allowed_service_ids = KycClientServicesManagement.objects.filter(
